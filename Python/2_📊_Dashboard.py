...
# Load the CSV file
df = pd.read_csv('https://github.com/CallMiAbhinav/Dashboards/blob/af3ef1bd73c8b23aef4a570da32a31d96c6d9bb6/Python/dairy_dataset.csv',sep=',',error_bad_lines=False)
