...
# Load the CSV file
df = pd.read_csv('https://raw.githubusercontent.com/CallMiAbhinav/Dashboards/af3d9a0c6fa987b28b79d1b6d3578f66d11ec12d/dairy_dataset.csv',sep=',',on_bad_lines='skip')
